...
Partial Class frmChof
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmChof))
        btnNuevo = New Button()
        txtDNI = New TextBox()
        txtApe = New TextBox()
        txtNom = New TextBox()
        ...
        btnAgrVeh = New Button()
        Label5 = New Label()
        Label4 = New Label()
        pnlDatChof = New Panel()
        PictureBox1 = New PictureBox()
        Label3 = New Label()
        label11 = New Label()
        Label2 = New Label()
        Label1 = New Label()
        pnlDGVChof = New Panel()
        ...
        btnNuevo.Image = My.Resources.Resources.icons8_más_nuevo_246
        btnNuevo.ImageAlign = ContentAlignment.MiddleRight
        btnNuevo.Location = New Point(139, 377)
        ...
        txtDNI.Location = New Point(29, 417)
        txtDNI.MaxLength = 10
        txtDNI.Name = "txtDNI"
        ...
        txtApe.Location = New Point(29, 461)
        txtApe.MaxLength = 50
        txtApe.Name = "txtApe"
        ...
        txtNom.Location = New Point(30, 505)
        txtNom.MaxLength = 50
        txtNom.Name = "txtNom"
        ...
        txtMail.Location = New Point(30, 549)
        ...
        txtTel.Location = New Point(30, 593)
        txtTel.MaxLength = 50
        txtTel.Name = "txtTel"
        ...
        btnGuaMod.Location = New Point(29, 646)
        ...
        btnResEli.Location = New Point(29, 683)
        ...
        ' btnAgrVeh
        ' 
        btnAgrVeh.Anchor = AnchorStyles.None
        btnAgrVeh.BackColor = Color.FromArgb(CByte(30), CByte(63), CByte(111))
        btnAgrVeh.FlatAppearance.BorderColor = Color.FromArgb(CByte(15), CByte(31), CByte(55))
        btnAgrVeh.FlatAppearance.BorderSize = 0
        btnAgrVeh.FlatAppearance.MouseDownBackColor = Color.FromArgb(CByte(30), CByte(63), CByte(111))
        btnAgrVeh.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(43), CByte(88), CByte(157))
        btnAgrVeh.FlatStyle = FlatStyle.Flat
        btnAgrVeh.Font = New Font("Microsoft Sans Serif", 12F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnAgrVeh.ForeColor = Color.WhiteSmoke
        btnAgrVeh.Image = My.Resources.Resources.icons8_auto_nuevo_24
        btnAgrVeh.ImageAlign = ContentAlignment.MiddleLeft
        btnAgrVeh.Location = New Point(29, 720)
        btnAgrVeh.Name = "btnAgrVeh"
        btnAgrVeh.Size = New Size(224, 55)
        btnAgrVeh.TabIndex = 14
        btnAgrVeh.Text = "  Agregar Vehículo"
        btnAgrVeh.UseVisualStyleBackColor = False
        ' 
        ' Label5
        ' 
        ...
        Label4.Location = New Point(29, 442)
        Label4.Name = "Label4"
        Label4.Size = New Size(77, 16)
        Label4.TabIndex = 4
        Label4.Tag = "Apellido(s)"
        Label4.Text = "Apellido(s)*"
        ' 
        ' pnlDatChof
        ' 
        pnlDatChof.BackColor = Color.FromArgb(CByte(232), CByte(238), CByte(249))
        pnlDatChof.Controls.Add(PictureBox1)
        pnlDatChof.Controls.Add(btnNuevo)
        pnlDatChof.Controls.Add(txtDNI)
        pnlDatChof.Controls.Add(txtApe)
        pnlDatChof.Controls.Add(txtNom)
        pnlDatChof.Controls.Add(txtMail)
        pnlDatChof.Controls.Add(txtTel)
        pnlDatChof.Controls.Add(btnGuaMod)
        pnlDatChof.Controls.Add(btnResEli)
        pnlDatChof.Controls.Add(btnAgrVeh)
        pnlDatChof.Controls.Add(Label5)
        pnlDatChof.Controls.Add(Label3)
        pnlDatChof.Controls.Add(Label4)
        pnlDatChof.Controls.Add(label11)
        pnlDatChof.Controls.Add(Label2)
        pnlDatChof.Controls.Add(Label1)
        pnlDatChof.Dock = DockStyle.Left
        pnlDatChof.Location = New Point(0, 0)
        pnlDatChof.Name = "pnlDatChof"
        pnlDatChof.Size = New Size(277, 1046)
        pnlDatChof.TabIndex = 0
        ' 
        ' PictureBox1
        ' 
        PictureBox1.Anchor = AnchorStyles.None
        PictureBox1.BackColor = Color.Transparent
        PictureBox1.Image = My.Resources.Resources.icons8_permiso_de_conducir_100__1_1
        PictureBox1.InitialImage = My.Resources.Resources.icons8_permiso_de_conducir_100__1_
        ...
        Label3.Location = New Point(29, 399)
        Label3.Name = "Label3"
        ...
        label11.Location = New Point(29, 486)
        ...
        Label2.Location = New Point(30, 530)
        Label2.Name = "Label2"
        ...
        Label1.Location = New Point(30, 574)
        Label1.Name = "Label1"
        ...
        ' pnlDGVChof
        ' 
        pnlDGVChof.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        pnlDGVChof.BackColor = Color.FromArgb(CByte(217), CByte(227), CByte(244))
        pnlDGVChof.Controls.Add(pnlDespDGV)
        pnlDGVChof.Controls.Add(pnlBusxFecha)
        pnlDGVChof.Controls.Add(btnBusxFecha)
        pnlDGVChof.Controls.Add(btnImpr)
        pnlDGVChof.Controls.Add(Label7)
        pnlDGVChof.Controls.Add(rbChofAct)
        pnlDGVChof.Controls.Add(rbChofCan)
        pnlDGVChof.Controls.Add(txtBusChof)
        pnlDGVChof.Controls.Add(dgvChoferes)
        pnlDGVChof.Location = New Point(279, 0)
        pnlDGVChof.Name = "pnlDGVChof"
        pnlDGVChof.Size = New Size(1635, 1046)
        pnlDGVChof.TabIndex = 1
        ' 
        ' pnlDespDGV
        ' 
        ...
        btnImpr.Location = New Point(1457, 10)
        ...
        Label7.TabIndex = 0
        Label7.Text = "Lista de Choferes"
        ' 
        ' rbChofAct
        ' 
        rbChofAct.Appearance = Appearance.Button
        rbChofAct.AutoSize = True
        rbChofAct.BackColor = Color.FromArgb(CByte(30), CByte(63), CByte(111))
        rbChofAct.FlatAppearance.BorderColor = Color.FromArgb(CByte(15), CByte(31), CByte(55))
        rbChofAct.FlatAppearance.BorderSize = 0
        rbChofAct.FlatAppearance.CheckedBackColor = Color.FromArgb(CByte(43), CByte(88), CByte(157))
        rbChofAct.FlatAppearance.MouseDownBackColor = Color.FromArgb(CByte(30), CByte(63), CByte(111))
        rbChofAct.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(43), CByte(88), CByte(157))
        rbChofAct.FlatStyle = FlatStyle.Flat
        rbChofAct.Font = New Font("Microsoft Sans Serif", 8.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        rbChofAct.ForeColor = Color.White
        rbChofAct.Image = My.Resources.Resources.icons8_conductor_de_taxi_alta_24
        rbChofAct.ImageAlign = ContentAlignment.MiddleLeft
        rbChofAct.Location = New Point(19, 52)
        rbChofAct.Name = "rbChofAct"
        rbChofAct.Size = New Size(107, 30)
        rbChofAct.TabIndex = 1
        rbChofAct.TabStop = True
        rbChofAct.Text = "       Activos     "
        rbChofAct.TextAlign = ContentAlignment.MiddleRight
        rbChofAct.UseVisualStyleBackColor = False
        ' 
        ' rbChofCan
        ' 
        rbChofCan.Appearance = Appearance.Button
        rbChofCan.AutoSize = True
        rbChofCan.BackColor = Color.FromArgb(CByte(30), CByte(63), CByte(111))
        rbChofCan.FlatAppearance.BorderColor = Color.FromArgb(CByte(15), CByte(31), CByte(55))
        rbChofCan.FlatAppearance.BorderSize = 0
        rbChofCan.FlatAppearance.CheckedBackColor = Color.FromArgb(CByte(43), CByte(88), CByte(157))
        rbChofCan.FlatAppearance.MouseDownBackColor = Color.FromArgb(CByte(30), CByte(63), CByte(111))
        rbChofCan.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(43), CByte(88), CByte(157))
        rbChofCan.FlatStyle = FlatStyle.Flat
        rbChofCan.Font = New Font("Microsoft Sans Serif", 8.25F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        rbChofCan.ForeColor = Color.White
        rbChofCan.Image = My.Resources.Resources.icons8_conductor_de_taxi_baja_24
        rbChofCan.ImageAlign = ContentAlignment.MiddleLeft
        rbChofCan.Location = New Point(126, 52)
        rbChofCan.Name = "rbChofCan"
        rbChofCan.Size = New Size(124, 30)
        rbChofCan.TabIndex = 2
        rbChofCan.TabStop = True
        rbChofCan.Text = "      Deshabilitados"
        rbChofCan.TextAlign = ContentAlignment.MiddleRight
        rbChofCan.UseVisualStyleBackColor = False
        ' 
        ' txtBusChof
        ' 
        txtBusChof.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        txtBusChof.BackColor = Color.FromArgb(CByte(243), CByte(247), CByte(252))
        txtBusChof.Font = New Font("Microsoft Sans Serif", 9.75F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtBusChof.ForeColor = SystemColors.WindowFrame
        txtBusChof.Location = New Point(970, 52)
        txtBusChof.MaxLength = 50
        txtBusChof.Name = "txtBusChof"
        txtBusChof.Size = New Size(427, 22)
        txtBusChof.TabIndex = 3
        ...
        dgvChoferes.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle5
        dgvChoferes.Anchor = AnchorStyles.Top Or AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right
        dgvChoferes.BackgroundColor = Color.FromArgb(CByte(243), CByte(247), CByte(252))
        ...
        dgvChoferes.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle6
        ...
        dgvChoferes.DefaultCellStyle = DataGridViewCellStyle7
        dgvChoferes.Location = New Point(19, 82)
        ...
        dgvChoferes.RowHeadersDefaultCellStyle = DataGridViewCellStyle8
        dgvChoferes.RowHeadersVisible = False
        dgvChoferes.SelectionMode = DataGridViewSelectionMode.FullRowSelect
        dgvChoferes.Size = New Size(1597, 952)
        dgvChoferes.TabIndex = 4
        ' 
        ' cmsChof
        ' 
        cmsChof.Items.AddRange(New ToolStripItem() {DeshabilitarToolStripMenuItem, ModificarToolStripMenuItem, DetalleToolStripMenuItem})
        cmsChof.Name = "cmsChof"
        cmsChof.Size = New Size(137, 70)
        ' 
        ...
        Controls.Add(pnlDGVChof)
        Controls.Add(pnlDatChof)
        FormBorderStyle = FormBorderStyle.None
        Name = "frmChof"
        Text = "frmChof"
        pnlDatChof.ResumeLayout(False)
        pnlDatChof.PerformLayout()
        CType(PictureBox1, ComponentModel.ISupportInitialize).EndInit()
        pnlDGVChof.ResumeLayout(False)
        pnlDGVChof.PerformLayout()
        ...
        CType(dgvChoferes, ComponentModel.ISupportInitialize).EndInit()
        cmsChof.ResumeLayout(False)
    ...
    Friend WithEvents btnAgrVeh As Button
    Friend WithEvents Label5 As Label
    Friend WithEvents Label4 As Label
    Friend WithEvents pnlDatChof As Panel
    Friend WithEvents Label3 As Label
    Friend WithEvents label11 As Label
    Friend WithEvents Label2 As Label
    Friend WithEvents Label1 As Label
    Friend WithEvents pnlDGVChof As Panel
    Friend WithEvents Label7 As Label
    Friend WithEvents rbChofAct As RadioButton
    Friend WithEvents rbChofCan As RadioButton
    Friend WithEvents txtBusChof As TextBox
    Friend WithEvents dgvChoferes As DataGridView
    Friend WithEvents ep As ErrorProvider
    Friend WithEvents PictureBox1 As PictureBox
    Friend WithEvents btnImpr As Button
    Friend WithEvents cmsChof As ContextMenuStrip
